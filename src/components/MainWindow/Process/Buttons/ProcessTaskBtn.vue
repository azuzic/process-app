<template>
    <div :class="selected ? 'border-2 border-main_green' : 'hover:bg-main_blackblue hover:cursor-pointer'" class="bg-main_darkblue rounded px-3 py-4 flex font-bold items-center mr-3 mb-6 text-sm w-36 h-24 relative">
